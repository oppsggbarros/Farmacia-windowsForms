...
namespace Farmacia.Back_End.ConexaoBanco
{
    public class Conexao : DbContext
    {
        ...
        {
            optionsBuilder.UseNpgsql("Host=localhost;Database=farmacia;Username=postgres;Password=1234");
            // Wii dante do futuro se vira 
        }
