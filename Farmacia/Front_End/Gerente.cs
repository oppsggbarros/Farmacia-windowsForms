...
//             buttonsTable.Controls.Add(new Button { Text = "Relatório de Estoque", BackColor = ColorTranslator.FromHtml("#233ED9"), ForeColor = ColorTranslator.FromHtml("#FFF"), Height = 50, Dock = DockStyle.Fill }, 1, 0);
